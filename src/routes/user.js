...
//const uploadFile = require('../middelware/multerMiddleware');
//const validations = require('../middelware/validateRegisterMiddleware');
...
routerUser.get('/logout/',authMiddleware, controladorUser.logout);
